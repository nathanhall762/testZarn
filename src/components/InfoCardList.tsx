  ...
  return (
    <>
      <div className='flex flex-col text-center px-8 py-8 gap-4'>
        ...
        <div className='flex flex-col lg:flex-row gap-8 lg:gap-16 pt-8 justify-center'>
          {cards.map((card) => (
            <div
              style={{ backgroundImage: `url('${card.bgImage}')` }}
              aria-label={card.altImageText}
              className='bg-cover pt-80 max-w-80 hover:scale-110 transform transition-transform'
            >
