  ...
  return (
    <header className='fixed top-0 z-50 w-screen transition-all duration-300 ease-in-out bg-transparent'>
      ...
      >
        ...
        >
          <div className='group cursor-pointer flex-grow flex justify-center gap-2 lg:gap-4 bg-dkbg1'>
            <Icon
        ...
        >
          <div className='group cursor-pointer flex-grow flex justify-center lg:gap-4 bg-dkbg1'>
            <Icon
              icon='mdi:email'
              className='text-accent group-hover:text-accent group-hover:scale-125 transition-all duration-300'
            />
      ...
      <div
        className={`relative top-0 flex w-screen justify-between text-center align-middle shadow-2xl transition-all duration-1000 lg:grid lg:grid-cols-12`}
      >
        <div className='items-center flex-grow justify-center align-middle lg:col-span-3 lg:flex bg-dkbg1  border-r-[1px] border-mdbg1'>
          <h2 className='text-center text-2xl text-black transition-all duration-300 hover:text-accent dark:text-white'>
            <a href='/'>{title}</a>
          </h2>
        </div>
        <nav className='hidden items-center justify-center gap-6 align-middle lg:col-span-6 lg:flex bg-dkbg1  border-r-[1px] border-mdbg1'>
          {navs.map((nav) => (
            <a
        ...
        <div
          onClick={toggleNav}
          className={`z-50 flex w-10 cursor-pointer items-center justify-center text-2xl text-black bg-dkbg1 transition-transform duration-300 lg:hidden dark:text-white ${isNavOpen ? 'rotate-180 opacity-100' : 'rotate-0 opacity-100'}`}
        >
        ...
        <div className='hidden lg:col-span-3 lg:flex lg:justify-around bg-dkbg1 px-4'>
          <div className='group cursor-pointer flex justify-center self-center gap-2 lg:gap-4 bg-dkbg1 py-2'>
            <Icon
              icon='akar-icons:phone'
