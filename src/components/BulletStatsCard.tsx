...
const BulletStatsCard: React.FC<Props> = ({
  ...
  return (
    <div
      className={`my-6 flex justify-center bg-cover bg-center text-black shadow-inner lg:h-[50vh] lg:px-32 dark:text-white`}
    ...
    >
      ...
      >
        <h3 className='text-primary pb-4 text-2xl lg:text-3xl'>{title}</h3>
