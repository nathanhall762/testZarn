      ...
      >
        <div className='relative z-10 px-4 pb-8 text-left lg:pb-16 lg:pl-16 lg:pr-64'>
          <div className='fade-in-up'>
            <h1 className='pb-2 text-xl font-normal text-neutral-2 drop-shadow-xl text-shadow-xl lg:text-3xl lg:text-neutral-1'>
              {capitalizeString(welcomeText)}
            </h1>
            <h2 className='mt-2 pb-8 text-3xl tracking-widest drop-shadow-xl text-shadow-xl lg:mt-6 lg:pb-16 lg:text-5xl'>
              {tagline}
            </h2>
            {callToActionLink && (
